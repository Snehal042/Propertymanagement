...
void buyers::menu()
{
	int choice,a;
		system("CLS");
		cout<<"WELCOME TO PROPERTY MANAGEMENT SYSTEM "<<endl;
		cout<<"1.User Registraion"<<endl;
		cout<<"2.See Available property"<<endl;
...
void buyers::see_real_estate()
{
	...
	if(_log==1)
	{
		cout<<"WELCOME TO PROPERTY MANAGEMENT SECTION"<<endl;
		cout<<"1.BUY"<<endl;
		cout<<"2.RENT"<<endl;
...
void buyers::user_choice(string city1,string type1,ifstream& r1)
{
	...
	it=it1=0;
	system("CLS");
	cout<<"WELCOME TO PROPERTY SEARCH ENGINE"<<endl;
	cout<<"Available property options are\n"<<endl;
	cout<<"PROPERTY ID\tCITY\tTYPE\tAREA\tADDRESS\t\tYEAR\tCOST"<<endl;//things to be added
	while(r1.good())
	{
...
//		getline(r1,real_det,'');//12
    ...
    it++;
		...
		if(it==1&&it1==1)
			{
				int j;
				for(i=info_real.begin(), j=0;i!=info_real.end();++i, j++)
				{
					if (j!=6 && !(j>=8 && j<=11) && j != 13)
						cout<<*i<<"\t";
					if (j==0)
						cout << "\t";
				}
...
void sellers::menu()
{
	int choice,a;
		...
		cout<<"WELCOME TO PROPERTY MANAGEMENT SYSTEM "<<endl;
		cout<<"1.User registraion"<<endl;
		cout<<"2.Enter the details of the property you want to sell"<<endl;
		cout<<"3.Return to main menu"<<endl;
		cin>>choice;
		switch(choice)
		{
...
void sellers::enter_data_real_estate()
{
	...
	if(_log==1)
	{
		cout<<"Enter the Information of property"<<endl;
		srand(time(NULL));
...
//		cin.ignore();
		...
		cout<<"Enter the AREA(in sqft) of the property:"<<endl;
		cin>>a;
		seller_info.push_back(a);
...
//		cin.ignore();
		...
		cout<<"The above property you want to:- \n1.'SELL' \nor\n 2.put on 'RENT'"<<endl;
		cin>>ch;
...
void admin::menu()
{
	...
	if(pass==pass_demo)
	{
			...
			cout<<"2.SHOW PROPERTY ON DATABASE"<<endl;
			cout<<"3.Return to main menu"<<endl;
			cin>>choice;
			switch(choice)
			{
...
void admin::show_real_estate()
{
	...
	int choice;
	cout<<"-------WELCOME ADMIN-------"<<endl;
	cout<<"1.SEE PROPERTY UNDER BUY SECTION"<<endl;
	cout<<"2.SEE PROPERTY UNDER RENT SECTION "<<endl;
	cout<<"3.BACK TO MAIN MENU"<<endl;
	cin>>choice;
	switch(choice)
	{
		case 1:
		{
			...
			cout<<"THE DETAILS OF PROPERTY UNDER BUY SECTION"<<endl;
		...
		case 2:
		{
			...
			cout<<"THE DETAILS OF PROPERTY UNDER RENT SECTION"<<endl;
			cout<<"UID\t\tNAME\t\tPASSWORD"<<endl;//to be added
			while(check.good())
			{
				getline(check,real_det,',');//0
